...
public class CodeGenerator {
	...
	private final static String MODULE = "user";
	
	//SQL URL
	private static String SQL_URL = "jdbc:mysql://127.0.0.1:3306/test?useUnicode=true&useSSL=false&characterEncoding=utf8&allowMultiQueries=true&serverTimezone=GMT%2B8";
	//SQL_DRIVER_NAME
	private static String SQL_DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
	//SQL_USERNAME
	...
	/** code  */
	//包路径
	private static String PACKAGE = "org.dubbo";
	//作者
...
//        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setDriverName(SQL_DRIVER_NAME);
		...
		pc.setParent(PACKAGE).setMapper("dao");
...
//        strategy.setSuperControllerClass("com.baomidou.ant.common.BaseController");	//自定义继承的Controller类全称，带包名
        strategy.setInclude(TABLE);		//需要包含的表名，允许正则表达式（与exclude二选一配置）
